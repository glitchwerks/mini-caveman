...
if (skillContent) {
  ...
  output =
    ...
    '## Boundaries\n\n' +
    'Persisted outside chat (code, comments, commits, docs, issue/PR text, memory files, third-party messages): write normal. "stop caveman" or "normal mode": revert. Level persist until changed or session end.';
}
